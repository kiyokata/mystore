  ...
  const handleSubmit = (e) => {
    ...
    return(
        ...
        <form className="bg-white w-full py-32  sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <Link to="/login" className="text-slate-400  w-1/2 text-center rounded-full py-2  font-light">Login</Link>
               <Link to="/signup" className="text-slate-800 w-1/2 inline-block bg-white mx-2 text-center rounded-lg py-2  font-semibold">Signup</Link>
