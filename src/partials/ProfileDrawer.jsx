...
export default function ProfileDrawer({  isProfileDrawerOpen, setIsProfileDrawerOpen }) {
  ...
  return (
    <div 
        ...
        className={
          "p-6 fixed top-0  right-0 overflow-y-auto z-40 bg-white w-72 h-screen transform ease-in-out " +
          (isProfileDrawerOpen
            ? " transition-transform opacity-100 duration-1000 translate-x-0  "
            : " transition-all opacity-0  duration-1000 translate-x-full  ")
      }
    >
       <h5 className="text-base font-semibold text-gray-950 uppercase dark:text-gray-400">Profile</h5>
